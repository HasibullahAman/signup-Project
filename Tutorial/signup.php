...
<head>
    ...
    <link rel="stylesheet" href="/Tutorial/Boostrap/bootstrap.min.css">
    <link rel="stylesheet" href="/Tutorial/fontawesome/css/all.min.css">
                ...
                <div class="row">
                    <form action="" method="POST" class="d-flex align-items-center input-row">
                        <div class="input-group mt-1 py-2">
                            <span class="input-group-text"><img src="/Tutorial/bootstrap-icons/person.svg" alt=""></span>
